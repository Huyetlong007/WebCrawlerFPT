...
namespace WebAutomation
{
    public class WooCommerceGenerator
    {
        ...
        /// </summary>
        /// <param name="products">List of product informations crawled from Jomashop</param>
        ...
        public void GenerateProductImportTemplate(List<Models.Product> products, string templateFile)
        {
            ...
            foreach(var product in products)
            {
                ...
                dataRow = dataRow.Replace(Environment.NewLine, "").Trim(); //Delete all new line character
